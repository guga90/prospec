        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <div class="pull-left">
                        <a href="{{route('smscampanha.create')}}" class="btn btn-default btn-flat">Cadastrar novo</a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!--a class="btn btn-info btn-sm" href="{{ route('smscampanha.show',$smscampanha->id) }}"><i class="glyphicon glyphicon-th-large"></i></a-->
                                        <a class="btn btn-primary btn-sm" href="{{ route('smscampanha.edit',$smscampanha->id) }}"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <form id="" method="POST" action="{{route('smscampanha') . ('/' . $smscampanha->id) }}" style="display: inline;"> {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                            <input name="id" type="hidden" value="{{ $smscampanha->id }}">  
